...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Adeeba Naushad";
        $("#favicon").attr("href","assests/images/pfp.jng");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: [ "<i>Web Developer</i>.",
            ...
            " <i>JavaScript Developer</i>.",
            " <i>Database Architect</i>.",
            "<i>MERN Developer</i>.",
            " <i>Problem Solver</i>.",
            "<i>Creative Thinker</i>.",],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
/* SCROLL PROJECTS */
srtop.reveal('.card-ad',{delay: 300}); 
